          ...
          child: Column(
            ...
            children: [
              TabBar(
                ...
                dividerHeight: 0,
                tabs: const [
                  Tab(child: Row(children: [Icon(Icons.date_range,size: 20,), SizedBox(width: 8), Text("My Task")])),
                  Tab(child: Row(children: [Icon(Icons.hourglass_bottom,size: 20,), SizedBox(width: 8), Text("Task Tracker")])),
                  Tab(child: Row(children: [Icon(Icons.restart_alt,size: 20,), SizedBox(width: 8), Text("Ongoing & Pending Task")])),
                  Tab(child: Row(children: [Icon(Icons.calendar_today,size: 20,), SizedBox(width: 8), Text("Working Summary")])),
                ],
              ),
