...
class CenterfaceScreen extends StatefulWidget {
  ...
  const CenterfaceScreen.Center_QR_screen({super.key,required this.white,
          ...
          decoration: BoxDecoration(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 450,),
                Center(child: Text("Scan Your QR code",style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold
                ),)),
                Center(child: Text("point your QR right at the box \nthen scan a QR",textAlign: TextAlign.center)),
                SizedBox(height: 50,),
                Center(
                  child: Row(
